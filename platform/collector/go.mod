...
require (
	...
	hexgate.dev/collector/extension/hexgatebiscuitauth v0.1.0
)
...
replace hexgate.dev/collector/extension/hexgatebiscuitauth => ./extension/hexgatebiscuitauth
