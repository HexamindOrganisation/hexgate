"""CLI entrypoint for `hexgate register`."""
...
def add_parser(subparsers: argparse._SubParsersAction) -> None:
    """Register the `register` subcommand on the top-level hexgate CLI.
...
def main(args: argparse.Namespace) -> int:
    """Entrypoint for the `hexgate register` subcommand."""
    ...
    # over file — see hexgate/bootstrap.py.
...
def _load_system_prompt(value: str) -> str:
    ...
    from hexgate.agents.factory import load_system_prompt
