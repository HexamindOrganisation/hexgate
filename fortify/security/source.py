...
class PlatformPolicySource:
    ...
    def __init__(
        ...
        *,
        ...
        # One source can be shared across concurrent runs (multi-user
        # proxies refresh per call); serialize fetches so the cached
        # bundle/etag pair never interleaves and concurrent refreshes
        # collapse into one round trip + cheap 304s.
